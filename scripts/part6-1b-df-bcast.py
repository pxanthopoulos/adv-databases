...
spark = SparkSession.builder.appName("part6-df-1b-bcast").getOrCreate()
...
joined_df = (
    dataset_filt_df
    .join(policedept_filt_df.hint("broadcast"), dataset_filt_df["AREA "] == policedept_filt_df["PREC"], "inner")
)

print("AREA - POLICE_DEP JOIN: BROADCAST")
joined_df.explain()
