...
spark = SparkSession.builder.appName("part6-df-1a-srepl").getOrCreate()
...
joined_df = (
    dataset_filt_df
    .join(policedept_filt_df.hint("shuffle_replicate_nl"), dataset_filt_df["AREA "] == policedept_filt_df["PREC"], "inner")
)

print("AREA - POLICE_DEP JOIN: SHUFFLE_REPLICATE_NL")
joined_df.explain()
