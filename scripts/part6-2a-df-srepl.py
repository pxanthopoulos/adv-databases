...
spark = SparkSession.builder.appName("part6-2a-df-srepl").getOrCreate()
...
joined_df = (
    dataset_filt_df
    .crossJoin(policedept_filt_df.hint("shuffle_replicate_nl"))
)

print("LOCATION - POLICE_DEP JOIN: SHUFFLE_REPLICATE_NL")
joined_df.explain()
