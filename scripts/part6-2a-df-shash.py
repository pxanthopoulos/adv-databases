...
spark = SparkSession.builder.appName("part6-2a-df-shash").getOrCreate()
...
joined_df = (
    dataset_filt_df
    .crossJoin(policedept_filt_df.hint("shuffle_hash"))
)

print("LOCATION - POLICE_DEP JOIN: SHUFFLE_HASH")
joined_df.explain()
